...
function main(){
    ...
    translateIfLoaded('#hvut-bottom>.hvut-lt-div', '加载中');
    ...
    switch (location){
        ...
        case 17:
            translateIfLoaded('.hvut-bt-equip', '获取附魔状态中');
            break;
...
function translateIfLoaded(selector, loadingText)
{
...
function translateOnChange(selector){
    if (!dictEquips) loadEquips();//加载字典
