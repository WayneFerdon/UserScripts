...
(function () {
    ...
    var dictsMap = {
        ...
        '#popup_box' : ['itemInfos', 'items', 'artifact', 'equipsInfo', 'equipsPart'],// 'equipsName'], //物品和装备悬浮窗，需要监听动态翻译
        ...
        // '.showequip' : ['equipsInfo','equipsName', 'equipsSuffix'], //装备独立信息页的装备信息，已经由上面翻译只需要翻译装备名和装备后缀补充
    ...
    var words = {
        ...
        */
        ...
        menu: {
            ...
            'Weapon Lottery' : '武器彩票',
            'Armor Lottery' : '防具彩票',
            'The Arena' : '竞技场(TheArena)',
            'The Tower' : '塔楼(TheTower)',
            'Ring of Blood' : '浴血擂台(RingOfBlood)',
            'GrindFest' : '压榨界(Grind.Fest)',
            'Item World' : '道具界(ItemWorld)',
            '/^Repair$/' : '装备修理',
            '/^Salvage$/' : '装备分解',
            '/^Reforge$/' : '装备重铸',
            '/^Soulfuse$/' : '装备魂绑',
    ...
    function initRestoreButton() {
        ...
        if (csp) {
            ...
            csp = document.querySelector('#showequip>div:last-child');
        }
    ...
    if (document.getElementById('textlog')) {
        ...
        document.head.appendChild(document.createElement('style')).innerHTML =
            '#change-translate{display:none;}#infopane{position:absolute}' +
            '#infopane:hover::after{content:"双击此处切换战斗翻译开关";position:relative;left:0; top: 27px;font-weight:bold}';
    }
