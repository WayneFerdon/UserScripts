...
(function () {
    ...
    var dictsMap = {
        ...
        '#popup_box' : ['itemInfos', 'items', 'artifact', 'equipsInfo', 'equipsPart', 'equipsName'],//, 'equipsInfo', 'equipsName'], //物品和装备悬浮窗，需要监听动态翻译
...
var words = {
    ...
    */
    ...
    messagebox: {
        ...
        'Messaging yourself must be the ultimate form of social withdrawal, kupo! Seek help, kupo!' : '给自己发邮件是社交退缩的形式，咕波！去找些别的乐子吧，咕波！',
    ...
    const dict = ['equipsInfo','equipsPart','equipsName','equipsSuffix'].map(buildDict).flat();
    for(let elem of document.body.querySelectorAll('.hvut-in-header.hvut-cphu-sub'))
    {
        translateText(elem,dict);
    }
    ...
    function translateHvutEq(){
        ...
        if(isNew)
        {
            setTimeout(translateHvutEq, 1000);
            setTimeout(translateHvutEq, 5000);
            setTimeout(translateHvutEq, 10000);
        }
    }
}());
